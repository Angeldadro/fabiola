...
# architecture
- Prefer lean architectures — drop unused dependencies, dead code, and disconnected backends. Confidence: 0.70
...
# ui
- Avoid hero parallax/fade effects — keep hero sections simple and static. Confidence: 0.70
